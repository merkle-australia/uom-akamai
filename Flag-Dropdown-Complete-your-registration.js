        ...
        function() {
            ...
            _createClass(Iti, [ {
                ...
                value: function _setFlag(countryCode) {
                    ...
                    document.getElementById("capture_socialRegistration_mobileNumber").value = this.selectedCountryData.dialCode;
                    if (this.options.separateDialCode) {
